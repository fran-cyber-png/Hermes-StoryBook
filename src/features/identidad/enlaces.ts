...
export const MOTIVO_ENLACE: Record<string, string> = {
  ...
  demasiadas_identidades: 'Esta ficha ya tiene demasiados contactos unidos. Deshaz alguno primero.',
  ...
  conflicto: 'Alguien más lo estaba enlazando en este mismo momento. Prueba de nuevo.',
};
