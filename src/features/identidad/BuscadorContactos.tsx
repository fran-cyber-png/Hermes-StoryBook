...
/**
 * «UNIR FICHAS» (antes «Es la misma persona que…») — buscar el otro contacto y confirmar la unión (#58).
 *
        ...
        >
          ...
          {elegido ? (
            <Confirmacion
              ...
              error={
                enlazar.error
                  ? (MOTIVO_ENLACE[motivoDeError(enlazar.error)] ?? 'No se pudo unir. Prueba de nuevo.')
                  : null
              }
              onVolver={() => {
                enlazar.reset();
              ...
              <div className="shrink-0 border-b border-border p-4">
                <label className="relative block">
                  ...
                  <input
                    ...
                    placeholder="Busca por nombre o por teléfono"
              ...
              <div className="min-h-0 flex-1 overflow-y-auto p-2">
                {texto.trim().length < 2 ? (
                  <p className="p-4 text-center text-xs text-muted-foreground">
                    Escribe al menos dos letras del nombre, o parte del número.
                  </p>
