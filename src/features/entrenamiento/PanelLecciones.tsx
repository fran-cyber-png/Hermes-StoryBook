      ...
      <div className="mx-auto flex max-w-3xl flex-col gap-5">
        <div className="rounded-md border border-border p-4">
          ...
          <p className="mb-3 text-xs text-muted-foreground">
            Queda en borrador: el bot no la lleva puesta hasta que la publiques. Pruébala antes
            con una corrida.
          </p>
          <textarea
            value={texto}
            ...
            rows={2}
            placeholder="Cuando pregunten por la fecha de inicio, di el día exacto y no «en agosto»."
