        ...
        <div className="mx-auto flex max-w-3xl flex-col gap-5">
          <div className="rounded-md border border-border p-4">
            ...
            <p className="mb-3 text-xs text-muted-foreground">
              Queda en borrador: el bot no la lleva puesta hasta que la publiques. Pruébala antes con una corrida.
            </p>
            <textarea rows={2} defaultValue="" placeholder="Cuando pregunten por la fecha de inicio, di el día exacto y no «en agosto»." className="mb-2 w-full resize-none rounded-md border border-border bg-background px-3 py-2 text-sm" />
          ...
          <div className="rounded-md border border-border">
            ...
            <div className="border-t border-border px-3 py-2">
              <div className="flex flex-col gap-2">
                <textarea rows={2} defaultValue="" placeholder="El dato que le faltaba, tal como quieres que lo diga." className="w-full resize-none rounded-md border border-border bg-background px-2 py-1.5 text-sm" />
                <div className="flex items-center gap-2">
                  <span className="text-xs text-muted-foreground">Queda en borrador: pruébalo con una corrida antes de publicarlo.</span>
      ...
      <header className="flex flex-wrap items-center gap-3 border-b border-border px-6 py-4">
        <div className="mr-auto">
          ...
          <p className="text-sm text-muted-foreground">
            Escríbele como si fueras una persona y mira qué contesta.
          </p>
        </div>
      ...
      <div className="border-t border-border bg-background px-6 py-4">
        <div className="mx-auto flex max-w-2xl flex-col gap-2">
          <textarea
            rows={2}
            defaultValue=""
            placeholder="Escribe como si fueras la persona…"
