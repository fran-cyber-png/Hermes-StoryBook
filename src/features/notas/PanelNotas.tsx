    ...
    <div className={siempreAbierto ? '' : 'border-t border-border p-3'}>
      ...
      <div className="mb-2 flex gap-1.5">
        <textarea
          ...
          maxLength={LIMITE_TEXTO}
          rows={2}
          placeholder="Anota algo — se guarda por ti, editable, nada sale de acá."
...
function ResultadosBusqueda({ q }: { q: string }) {
  ...
  if (busqueda.isError) return <p className="text-xs text-warning-foreground">No se pudo buscar. Prueba de nuevo.</p>;
