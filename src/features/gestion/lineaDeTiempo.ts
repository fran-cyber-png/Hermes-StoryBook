...
export function propuestaDeCurso(
  ...
  return {
    ...
    confirmable,
    detalle: confirmable
      ? `${derivado.curso} — deducido ${origen} «${derivado.textoOrigen}». Confirma para registrarlo.`
      : `Vino ${origen} «${derivado.textoOrigen}», que no está mapeado a ningún curso: búscalo y regístralo.`,
  };
}
