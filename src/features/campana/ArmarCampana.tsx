...
/**
 * ARMAR UNA CAMPAÑA — elige la plantilla, elige la lista, autoriza.
 *
        ...
        <div className="max-h-[70vh] space-y-4 overflow-auto p-4">
          ...
          <section>
            ...
            {plantillas.isPending ? (
              ...
              <Aviso texto="No hay ninguna plantilla aprobada para usar. Crea una en la sección Plantillas y espera a que Meta la revise." />
            ) : (
          ...
          <section>
            ...
            {listas.isPending ? (
              ...
              <Aviso texto="No hay ninguna lista guardada. Arma una en la sección Listas: es el recorte del padrón al que le va a llegar." />
            ) : (
              <ul className="space-y-1.5">
