/**
 * CÓMO SE LLAMA ESTA PERSONA — con cuatro nombres compitiendo y ninguno
 * confiable por igual.
 *
 ...
 * misma** en el formulario, las fichas de Cerberus con el nombre legal, y lo que
 * alguien del equipo anotó a mano en «Registrar contacto» (`contacto_ficha`,
 * ADR 0060) — que en campaña, sin Cerberus ni lead-form, es a menudo el ÚNICO
 * nombre que existe (ampliación del 25-ago-2026: sin esto, un contacto recién
 * creado con «Nuevo contacto» y ya reclamado por «Mensaje» seguía diciendo «Sin
 * nombre» en el encabezado, aunque el nombre ya estuviera guardado).
 *
...
export type FuenteNombre = 'cerberus' | 'formulario' | 'ficha' | 'whatsapp' | 'ninguna';
