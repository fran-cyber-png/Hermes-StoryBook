    ...
    >
      <div className="space-y-3 p-5">
          ...
          <div className="rounded-xl border border-primary/30 bg-primary/5 p-3">
            ...
            {guardar.isError && (
              <p className="mt-1.5 text-[11px] text-destructive">
                No se guardó el interés — prueba con el buscador de abajo.
              </p>
            )}
          </div>
        )}
        ...
        <p className="text-xs text-muted-foreground">
          {sugerido?.hayQueRegistrar
            ? 'O busca otro curso: al guardarlo, la tarjeta pasa sola a «Saben el precio».'
            : 'Confirma el curso con el que llegó, o búscalo y agrégalo: al guardarlo, la tarjeta pasa sola a «Saben el precio».'}
        </p>
        ...
        {isPending ? (
          ...
          <div className="flex items-start gap-2 rounded-xl border border-warning/40 bg-warning/10 p-3 text-xs text-warning-foreground">
            ...
            <span>
              ...
              estaba; prueba de nuevo en un rato.
            </span>
          </div>
        ) : (
          <>
            ...
            <p className="text-xs text-muted-foreground">
              Abre la conversación: desde la ficha se registra la conversión y está el alta en
