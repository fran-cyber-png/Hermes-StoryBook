        ...
        {!esTelefono ? (
          ...
          <div className="flex flex-col gap-3.5">
            {/* ══ LOS CAMPOS DE IDENTIDAD SE FUERON A «QUIÉN ES» ═══════════
                ...
                Ahora los resuelve `panel/QuienEs.tsx` con la precedencia que ya
            ...
            <div>
              <div className={encabezadoSeccion}>
                <ShoppingBag size={14} className="text-muted-foreground" /> Compras ({data.ventasCount})
              </div>
                ...
                <ul className="flex flex-col gap-1.5">
                  {data.ventas.map((v) => (
                    ...
                    >
                      ...
                      <span className={'rounded-full border px-1.5 py-0.5 text-[10px] font-semibold ' + claseEstadoVenta(v.estado)}>
                        {v.estado}
                      </span>
