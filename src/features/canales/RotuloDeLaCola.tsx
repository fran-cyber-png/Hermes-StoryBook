/**
 * EL RÓTULO DEL NÚMERO DE LA COLA — «N en cola» vs. «N para ti».
 *
 ...
 * pantalla: cuando se retiró la píldora «Tú» de cada fila, lo que quedó diciendo
 ...
 * pondría «para ti» a una cola que trae el trabajo de todas.
 *
 ...
 * de siempre —«lo que te tocó a ti y lo que todavía no tiene dueña»— le
 ...
 * agregado.
 *
 * ⚠️ **Lo que NO cambia es la palabra visible**: sigue diciendo «para ti»,
 * porque sigue siendo cierto y porque el rótulo se lee de reojo — dos etiquetas
 * distintas para el mismo hecho («para ti» / «tu línea») harían que la de al
...
export function RotuloDeLaCola({
  ...
  return (
    ...
    >
      {total.toLocaleString('es')} {recortada ? 'para ti' : 'en cola'}
    </span>
  );
}
