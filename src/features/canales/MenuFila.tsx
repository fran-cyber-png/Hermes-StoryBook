...
export function MenuFila({
  ...
  return (
    <span
      className={
        // Esquina inferior derecha (rediseño 28-ago-2026, pedido del dueño): antes
        // vivía arriba, pegada a la hora. El `pr-9` que `FilaConversacion` reserva
        // corre toda la altura de la fila, así que bajarla no descubre ningún
        // texto — sigue en el mismo canal vertical, sólo que abajo.
        'absolute right-1.5 bottom-2 z-10 inline-flex transition-opacity ' +
