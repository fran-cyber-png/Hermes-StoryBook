...
const CASOS: { rotulo: string; total: number; recortada?: boolean; lineaPropia?: boolean }[] = [
  ...
  {
    rotulo:
      'SINDY — el caso donde el número por fin coincide con las filas: la cola le servía 3.095 y la cabecera le decía 5.494. Con dos dígitos, «para ti» es lo único que separa «me asignaron poco» de «se rompió algo».',
    total: 192,
    recortada: true,
  },
  {
