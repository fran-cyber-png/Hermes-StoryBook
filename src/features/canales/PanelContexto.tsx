 ...
 * el puente — pero **antes de tocarlo, verifica si se reconecta o se archiva**;
  ...
  return (
    ...
    >
      ...
      <div className={embebida ? 'min-h-0 flex-1 overflow-y-auto' : 'min-h-0 flex-1 overflow-y-auto px-4 py-4'}>
            ...
            <div className="mt-2 rounded-xl border border-border bg-muted/40 p-3 text-xs leading-relaxed text-muted-foreground">
              <p className="flex items-start gap-2">
                ...
                <span>
                  ...
                  Si te pasa su número en el chat, búscalo en la vista <span className="font-semibold text-foreground">Contactos</span> y
                  ahí tienes su ficha completa.
                </span>
              </p>
            </div>
          </>
        ...
        {/* «Unir Fichas» (#58) — acá es donde más falta hace: un DM de
