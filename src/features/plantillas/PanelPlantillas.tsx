      ...
      <div className="min-w-0 flex-1">
        ...
        {paso.faltantes.length > 0 && (
          <p className="mt-1 flex items-start gap-1 text-[10px] text-destructive">
            ...
            No se pudo traer {paso.faltantes.join(' ni ')} — complétalo a mano antes de mandar.
          </p>
        )}
      </div>
    </li>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto pr-0.5">
        ...
        {isPending ? (
          ...
          <p className="px-1 text-[11px] leading-relaxed text-muted-foreground">
            Todavía no hay ninguna secuencia aprobada. Aprueba una de las de arriba y aparece acá,
            lista para mandar.
          </p>
        ) : plantillas.length === 0 ? (
          <div className="rounded-xl border border-dashed border-border p-4 text-center">
            ...
            <p className="mt-1 text-[11px] leading-relaxed text-muted-foreground">
              Se pueden aprender del histórico —lo que ya mandas todos los días— con{' '}
                      ...
                      <span className="flex items-center gap-1.5">
                        ...
                        {p.alcance === 'equipo' && (
                          /* La marca del equipo se VE sin abrir la tarjeta: con
                             ...
                             todas cambia si la editas o la dejas quieta. */
                          <span
                    ...
                    <div className="animate-entrar border-t border-border px-2.5 py-2">
                      {preparar.isPending ? (
                        ...
                        <p className="py-1 text-[11px] text-destructive">
                          No se pudo preparar la secuencia. Prueba de nuevo.
                        </p>
                          ...
                          {envio.estado.fase !== 'lista' ? (
                            ...
                            <div className="flex flex-wrap items-center gap-1.5">
                              ...
                              <button
                                ...
                                title={porArchivar === p.id ? 'Toca de nuevo para archivar' : 'Archivar'}
