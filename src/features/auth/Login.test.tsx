 ...
 * el fallback y la pantalla decía «revisa tu internet» a alguien que tiene la
...
const MENSAJE_SIN_LINEA = 'todavía no tienes una línea de WhatsApp asignada en Hermes — avisa a soporte';
...
describe('Login — el cartel de error', () => {
  it('🔴 un 403 sin_linea_asignada muestra lo que dijo el server, no «revisa tu internet»', async () => {
