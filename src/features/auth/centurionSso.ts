 ...
 * genérico —«prueba de nuevo, o entra con usuario y contraseña»— la persona se
...
export function mensajeDeErrorCenturion(err: unknown): string {
  ...
  if (err instanceof ErrorApi && err.status === 401) {
    return 'Ese link de Centurión venció o ya se usó. Vuelve a entrar desde Centurión.';
  }
  return 'No pude validar el link de Centurión. Prueba de nuevo, o entra con usuario y contraseña.';
}
