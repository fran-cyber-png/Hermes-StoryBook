 ...
 * «vuelve a entrar» sin darle por dónde. En el peor momento posible: con el
...
export function AvisoCerberus({
  ...
  async function reconectar() {
    ...
    try {
      ...
      setError('No se pudo reconectar. Revisa la contraseña y prueba de nuevo.');
    } finally {
      setYendo(false);
    }
  }
        ...
        <>
          ...
          <div className="absolute right-0 top-full z-50 mt-2 w-80 rounded-xl bg-card p-4 shadow-panel animate-entrar">
            ...
            <p className="mt-2 text-[11px] leading-relaxed text-muted-foreground">
              No pierdes nada: sigues siendo tú, con tu cola y tus conversaciones donde estaban.
            </p>
          </div>
        </>
      )}
  ...
  return (
    <div className="flex flex-col items-center gap-3 p-8 text-center">
      ...
      <p className="max-w-xs text-xs leading-relaxed text-muted-foreground">
        ...
        reinicia. Reconecta y vuelve a abrir la venta — no pierdes nada de lo demás.
      </p>
      <button
        type="button"
