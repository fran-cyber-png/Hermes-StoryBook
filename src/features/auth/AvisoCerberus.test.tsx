 ...
 *
 * El aviso promete un arreglo: «reconecta y sigues». Para una identidad de
 * Centurión esa promesa es falsa —no hay usuario que autenticar en Cerberus, así
 * que `entrar()` vuelve a no dejar cookie— y el ciclo queda cerrado: recargas,
...
describe('AvisoCerberus', () => {
  it('a una vendedora de Cerberus sí se le avisa: es lo que le destraba la venta', () => {
    ...
    expect(montado.contenedor.textContent).toMatch(/Reconecta con Cerberus/i);
