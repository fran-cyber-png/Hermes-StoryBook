  ...
  if (dijo.clase === 'sin-texto') {
    return (
      <Nota tono="atento">
        ...
        escúchalo en el hilo antes de aprobar.
      </Nota>
    );
  }
  ...
  return (
    <div>
      ...
      {esCopy ? (
        ...
        <Nota tono="atento">
          Esto <b>lo escribió ella</b>. Si la plantilla no se lo contesta, edítala antes de aprobar.
        </Nota>
      )}
    </div>
  );
  ...
  return (
    <div>
      ...
      <ul className="mt-1 space-y-0.5 text-[10px] leading-relaxed text-muted-foreground">
        ...
        <li>· se cancela sola si contestas tú primero</li>
      </ul>
    </div>
  );
}
