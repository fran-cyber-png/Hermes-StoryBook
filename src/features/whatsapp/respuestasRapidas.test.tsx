...
const HECHOS = [
  ...
  { clave: 'acceso', rotulo: 'Acceso un año', texto: 'El acceso lo tienes por todo un año.', momentos: [], orden: 2, activo: true },
...
describe('elegir con el teclado', () => {
  ...
  test('las flechas mueven la marca y Enter toma la marcada', async () => {
    ...
    teclear('Enter', { target: caja(m) });
    await reposar();
    expect(caja(m).value).toBe('El acceso lo tienes por todo un año.');
  });
