...
const LECTURAS: Record<string, string> = {
  ...
  /**
   * 🔴 EL MÁS FRECUENTE DE TODOS, Y NO ES CULPA DE LA VENDEDORA NI DEL NÚMERO.
   *
   * Medido el 21-ago-2026 en producción: **217 fallos**, más que todos los otros
   * códigos juntos (131026: 79 · 131047: 7). El detalle crudo que manda Meta es
   * «your WhatsApp Business account has unsettled payments». O sea: **una factura
   * impagable, no el texto ni la persona ni un tope de marketing** — que era
   * justo la causa que se le estaba atribuyendo mientras el código decía otra cosa.
   *
   * Por eso la lectura nombra a quién le toca resolverlo: reintentar no sirve, y
   * cambiar de plantilla tampoco.
   */
  '131042': 'la cuenta de WhatsApp Business tiene pagos pendientes con Meta. No es el número ni el texto: hasta que se regularice el pago no sale nada. Avisa al administrador.',
