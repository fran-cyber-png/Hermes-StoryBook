...
describe('arrastrar un archivo al chat', () => {
  test('soltar una imagen en cualquier parte de la ventana la deja como adjunto', async () => {
    ...
    expect(m.contenedor.textContent).toContain('Suelta el archivo acá');
    ...
    expect(m.contenedor.textContent).not.toContain('Suelta el archivo acá');
  });
  ...
  test('🔴 una imagen arrastrada desde una WEB no navega, y lo dice', async () => {
    ...
    expect(m.contenedor.textContent).toContain('Bájalo primero');
