 ...
 *
 * ⚠️ **«No tiene foto» y «no se pudo traer la foto» se dibujan IGUAL, y es una
 * decisión.** Desde el 19-ago-2026 el hook sí distingue los dos casos —tiene
 * que hacerlo para no reintentar 88 veces por día lo que ya falló
 * (`lib/datos/frenoDeMedia.ts`)— pero acá no se usa esa etiqueta: que la línea
 * de WhatsApp esté reconectando es un hecho sobre NUESTRO transporte, no sobre
 * el contacto, y dibujarlo en su círculo le pondría un cartel de problema a una
 * persona que no tiene ninguno. Las iniciales ya son la respuesta correcta a
 * «no tengo la foto», venga de donde venga. El estado de la línea se dice donde
 * corresponde: en el chip de la cabecera.
 */
